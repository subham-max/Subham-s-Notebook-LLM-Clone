...
const PDFViewer = ({ documentId, filename, pageCount, currentPage, onPageChange }) => {
  ...
  const fetchPDF = async () => {
    ...
    try {
      ...
      const docResponse = await axios.get(`https://backend-for-notebookllm.onrender.com/api/documents/${documentId}`);
      const { filepath } = docResponse.data;

      const fullUrl = `https://backend-for-notebookllm.onrender.com${filepath}`;
        ...
        <div className="pdf-content" style={{
          ...
          <div style={{ textAlign: 'center', maxWidth: '90%' }}>
            ...
            <div style={{ fontSize: '0.9rem', color: '#666' }}>
              ...
              1. Is backend running on <code style={{ background: '#f1f1f1', padding: '2px 6px' }}>https://backend-for-notebookllm.onrender.com</code>?<br />
              ...
              <code style={{ 
                ...
                https://backend-for-notebookllm.onrender.com{docResponse?.data?.filepath || '/uploads/...'}
              </code>
            </div>
          </div>
        </div>
